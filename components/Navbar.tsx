      ...
      >
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-white text-[18px] font-bold cursor-pointer flex font-mono tracking-tighter">
          ...
          <button
            ...
            className="text-white focus:outline-none z-50 p-2 rounded-full hover:bg-white/5 transition-colors group flex items-center gap-3"
          >
            <span className="hidden md:block font-mono text-xs tracking-widest uppercase text-muted group-hover:text-white transition-colors">
              {isOpen ? 'Close' : 'Menu'}
            </span>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-background/95 backdrop-blur-xl z-30 flex flex-col justify-center items-center"
          >
            ...
            <ul className="list-none flex flex-col gap-6 md:gap-8 items-center justify-center relative z-10">
