  ...
  return (
    <>
      <div className="mb-20 text-center">
        ...
        <h2 className="text-4xl md:text-5xl font-bold text-text tracking-tight">{t.ui.my} {t.ui.experience} & {t.ui.education}</h2>
      </div>

      <div className="flex flex-col lg:flex-row gap-20 lg:gap-12">
        <TimelineBlock title={t.ui.education} icon={GraduationCap} items={t.educationTimeline} />
        <TimelineBlock title={t.ui.experience} icon={Briefcase} items={t.experienceTimeline} />
      </div>
    </>
  );
};
